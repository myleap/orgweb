...
//            }
    ...
    u.get = function (moduleName, data, callback) {
        ...
        console.log("get(" + trandNo + ")-url-" + ajaxUrl + "-" + JSON.stringify(data));
        ...
        $.ajax({
            ...
            console.log("get(" + trandNo + ") 返回== " + JSON.stringify(result) + "-1-" + JSON.stringify(err));
    ...
    u.getUrl = function (ajaxUrl, callback) {
        ...
        console.log("get(" + trandNo + ")-url-" + ajaxUrl);
